...
namespace ProductsAPI.Data
{
    public class ProductsAPIContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=1234;Trusted_Connection=True");
